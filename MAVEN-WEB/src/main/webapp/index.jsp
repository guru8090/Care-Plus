...
<link rel="stylesheet" href="AI_chatbot/style.css">
...
<header>
	...
	<main class="mb-5">
			...
			<div id="carouselExampleInterval" class="carousel slide"
				...
				<div class="carousel-inner">
					...
					<div class="carousel-item" data-bs-interval="2000">
						<img src="image/17806127_5893284.jpg"
							class="d-block w-100" alt="image2" style="height: 350px">
					</div>
					<div class="carousel-item" data-bs-interval="2000">
						<img src="image/37641679_8515556.jpg"
							class="d-block w-100" alt="image3" style="height: 350px">
					</div>
					<div class="carousel-item" data-bs-interval="2000">
						<img src="image/41604752_8950740.jpg"
							class="d-block w-100" alt="image3" style="height: 350px">
					</div>
					<div class="carousel-item" data-bs-interval="2000">
						<img src="image/66248991_9569876.jpg"
							class="d-block w-100" alt="image3" style="height: 350px">
					</div>
				</div>
			...
			<div class="container-fluid">
				<div class="row p-4 g-4">
					...
					<div class="col-lg-4 key_featcher_doctor_image">
						<img src="image/Adobe Express - file.png"
							alt="doctor_image">
					</div>
				</div>
			</div>
			...
			<div
				...
				<div class="doctor_image">
					<div
						...
						<img src="image/doctor_team_image1.jpg" alt=""
				...
				<div class="doctor_image">
					<div
						class="img-thumbnail d-flex flex-column align-items-center text-center">
						<img src="image/doctor_team_image5.webp" alt=""
							class="img-fluid" style="width: 150px;">
						<div class="doctor_name mt-2">
							<p class="mb-1">
								<b>Dr. Ananya Ray</b>
				...
				<div class="doctor_image">
					<div
						class="img-thumbnail d-flex flex-column align-items-center text-center">
						<img src="image/doctor_team_image2.jpg" alt=""
							class="img-fluid" style="width: 150px;">
						<div class="doctor_name mt-2">
							<p class="mb-1">
				...
				<div class="doctor_image">
					<div
						class="img-thumbnail d-flex flex-column align-items-center text-center">
						<img src="image/doctor_team_image3.jpg" alt=""
							class="img-fluid" style="width: 150px;">
						<div class="doctor_name mt-2">
							<p class="mb-1">
				...
				<div class="doctor_image">
					<div
						class="img-thumbnail d-flex flex-column align-items-center text-center">
						<img src="image/doctor_team_image4.jpg" alt=""
							class="img-fluid" style="width: 150px;">
						<div class="doctor_name mt-2">
							<p class="mb-1">
        ...
        <div id="inputbox" class="bg-white">
            <div
                class="chatbot_header d-flex justify-content-between align-items-center py-1 px-2 text-white" style="background-color:#019ade">

                <div class="d-flex align-items-center gap-2">
                    <img class="chatbot_image"
                        src="image/medical_logo.webp"
                        alt="chatbot_image">
                    <h5 class="text-center m-0">SG bot</h5>
                </div>

                <button id="disapperInputBox"><i class="fa-solid fa-xmark"></i></button>
            </div>

            <div id="output" style="height:80%">
                <div id="welcome" class="mt-5" style="color:#019ade">

                    <h4 class=" text-center">Welcome to Care<b>+</b></h4>
                </div>
                <div id="answer" class="d-flex flex-column gap-2 overflow-x-hidden text-wrap">

                </div>
            </div>

            <div class="d-flex align-items-center px-2 takeInput gap-2">
                <input type="text" placeholder="Type your question here...." id="inp">
                <button id="btn"><i class="bi bi-send text-black"></i></button>
            </div>

        </div>
    <button id="icon" style="border:none;color:#019ade"><i class="bi bi-chat-text-fill"></i></button>
    <script src="AI_chatbot/script.js"></script>
		</section>
	</main>
	<footer>
